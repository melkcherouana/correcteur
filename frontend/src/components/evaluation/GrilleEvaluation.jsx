...
const PALIERS = [
  {
    ...
    badgeCls: 'bg-gray-100 text-gray-500 dark:bg-slate-700 dark:text-slate-400',
    btnActiveCls: 'bg-gray-100 text-gray-600 border-gray-400 ring-2 ring-gray-300 ring-offset-1 shadow-sm dark:bg-slate-700 dark:text-slate-300 dark:border-slate-500 dark:ring-slate-600',
  ...
  },
  {
    ...
    btnActiveCls: 'bg-red-100 text-red-700 border-red-400 ring-2 ring-red-300 ring-offset-1 shadow-sm dark:bg-red-900/40 dark:text-red-300 dark:border-red-700 dark:ring-red-800',
  ...
  },
  {
    ...
    btnActiveCls: 'bg-orange-100 text-orange-700 border-orange-400 ring-2 ring-orange-300 ring-offset-1 shadow-sm dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-700 dark:ring-orange-800',
  ...
  },
  {
    ...
    btnActiveCls: 'bg-yellow-100 text-yellow-700 border-yellow-400 ring-2 ring-yellow-300 ring-offset-1 shadow-sm dark:bg-yellow-900/40 dark:text-yellow-300 dark:border-yellow-700 dark:ring-yellow-800',
  ...
  },
  {
    ...
    btnActiveCls: 'bg-green-100 text-green-700 border-green-500 ring-2 ring-green-300 ring-offset-1 shadow-sm dark:bg-green-900/40 dark:text-green-300 dark:border-green-700 dark:ring-green-800',
